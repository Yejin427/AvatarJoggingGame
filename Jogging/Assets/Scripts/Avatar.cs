...
public class Avatar : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        rightUpperArm.localScale = new Vector3(rightUpperArm.localScale.x, rightUpperArm.localScale.y * (PersonalData.armLength / PersonalData.womanArmLength), rightUpperArm.localScale.z);
        rightLowerArm.localScale = new Vector3(rightLowerArm.localScale.x, rightLowerArm.localScale.y * (PersonalData.armLength / PersonalData.womanArmLength), rightLowerArm.localScale.z);
        leftUpperArm.localScale = new Vector3(leftUpperArm.localScale.x, leftUpperArm.localScale.y * (PersonalData.armLength / PersonalData.womanArmLength), leftUpperArm.localScale.z);
        leftLowerArm.localScale = new Vector3(leftLowerArm.localScale.x, leftLowerArm.localScale.y * (PersonalData.armLength / PersonalData.womanArmLength), leftLowerArm.localScale.z);

        //upper body
        Transform spine = animator.GetBoneTransform(HumanBodyBones.Spine);
        Transform chest = animator.GetBoneTransform(HumanBodyBones.Chest);
        Transform upperChest = animator.GetBoneTransform(HumanBodyBones.UpperChest);
        spine.localScale = new Vector3(spine.localScale.x, spine.localScale.y * (PersonalData.upperBodyLength / PersonalData.womanBodyLength), spine.localScale.z);
        chest.localScale = new Vector3(chest.localScale.x, chest.localScale.y * (PersonalData.upperBodyLength / PersonalData.womanBodyLength), chest.localScale.z);
        upperChest.localScale = new Vector3(upperChest.localScale.x, upperChest.localScale.y * (PersonalData.upperBodyLength / PersonalData.womanBodyLength), upperChest.localScale.z);
        ...
        leftUpperLeg.localScale = new Vector3(leftUpperLeg.localScale.x, leftUpperLeg.localScale.x * (PersonalData.height / PersonalData.womanHeight), leftUpperLeg.localScale.z);
        rightUpperLeg.localScale = new Vector3(rightUpperLeg.localScale.x, rightUpperLeg.localScale.x * (PersonalData.height / PersonalData.womanHeight), rightUpperLeg.localScale.z);
        leftLowerLeg.localScale = new Vector3(leftLowerLeg.localScale.x, leftLowerLeg.localScale.x * (PersonalData.height / PersonalData.womanHeight), leftLowerLeg.localScale.z);
        rightLowerLeg.localScale = new Vector3(rightLowerLeg.localScale.x, rightLowerLeg.localScale.x * (PersonalData.height / PersonalData.womanHeight), rightLowerLeg.localScale.z);
